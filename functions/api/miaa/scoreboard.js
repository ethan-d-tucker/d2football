export async function onRequest(context) {
  ...
  const resp = (obj, code=200) => new Response(JSON.stringify(obj), {
    status: code, headers: { 'content-type': 'application/json; charset=utf-8', 'cache-control': 'public, max-age=15, s-maxage=60', 'access-control-allow-origin': '*' }
  });
  ...
  function guessWeek(y, m, d){
    ...
    const start = new Date(`${y}-08-25T12:00:00Z`);
