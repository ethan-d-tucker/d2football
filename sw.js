...
const CACHE='miaa-v13';
const SHELL=['./','./index.html','./standings.html','./rankings.html','./assets/css/styles.css','./assets/js/scores.js?v=13','./assets/js/standings.js?v=13','./assets/js/rankings.js?v=13'];
