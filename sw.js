// Simple SW
const CACHE='miaa-v9'; const SHELL=['./','./index.html','./standings.html','./rankings.html','./assets/css/styles.css','./assets/js/scores.js','./assets/js/standings.js','./assets/js/rankings.js'];
